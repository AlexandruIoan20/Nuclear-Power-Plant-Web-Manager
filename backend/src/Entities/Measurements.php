...
class Measurement {
    ...
    public function getVibration(): ?float { return $this->vibration; }
    ...
    public function setVibration(?float $vibration): void { $this->vibration = $vibration; }
}